...
class AttendanceRepository
{
    public function list($event_id)
    {
        ...
        return DB::table('employees')
            ...
            ->select(DB::raw("employees.biometric_id,CONCAT(TRIM(lastname),', ',TRIM(firstname),' ',SUBSTR(TRIM(IFNULL(middlename,'')),1,1)) as employee_name,divisions.div_code,departments.dept_name,job_title_name,events_att.att_status,events_att.att_status_code"))
